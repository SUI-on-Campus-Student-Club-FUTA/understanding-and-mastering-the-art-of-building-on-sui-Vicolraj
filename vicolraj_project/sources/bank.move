/*
/// Module: vicolraj_project
module vicolraj_project::vicolraj_project;
*/
...
// This module defines the Bank and its operations for the vicolraj_project.
// It provides functions to create accounts, deposit, withdraw, and transfer funds between accounts.
module vicolraj_project::bank {
    ...
    use vicolraj_project::account_move::{ 
        Account, 
        AccountCap,
        new, 
        get_owner, 
    ...
    use vicolraj_project::manager::{Self,  BankManagerCap};
